...
public class RegistryHelper {
    ...
    private static ResourceLocation loc(String name) {
        return new ResourceLocation(MythicalBiomes.MODID, name);
    }
    ...
    public static <T extends Block> T registerBlock(String name, T block, int burntime) {
        return registerBlock(name, block, new BlockItem(block, new Item.Properties().group(MBItemGroups.MYTHICAL_BIOMES_BLOCKS)) {
            @Override
    ...
    public static Item registerWallOrFloorItem(String name, Block floor, Block wall) {
        Item item = new WallOrFloorItem(floor, wall, new Item.Properties().group(MBItemGroups.MYTHICAL_BIOMES_BLOCKS));
        BLOCK_ITEMS.add(registerBlockItem(name, item));
        return item;
    }
